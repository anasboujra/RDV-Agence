                        ...
                        <div class="Employe-info">
                            ...
                            <div class="Employe-info-body">
                                ...
                                <div class="Employe-info-list d-flex justify-content-between pr-4 mt-3">
                                    <ul class="list">
                                        <li>
                                            <span class="list-span"><i class="fas fa-phone-alt mr-2"></i></i><c:out value="${client.numTele }"/></span>
                                        </li>
                                        <li>
                                ...
                                <div class="Employe-info-contact">
                                    <ul class="list-inline">
	                                    ...
	                                    <li class="list-inline-item float-right mr-3">
	                                            <a href="#" data-toggle="modal" data-target="#confirm-delete" class="modal-trigger" data-href="?do=supprimer&id=<c:out value="${client.id }"/>">
